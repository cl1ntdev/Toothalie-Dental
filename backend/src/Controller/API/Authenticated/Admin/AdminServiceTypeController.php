...
final class AdminServiceTypeController extends AbstractController
{
    ...
    #[
        Route(
            ...
            methods: ["POST"],
            name: "admin_create_service_type",
        ),
    ]
    ...
    #[
        Route(
            "/api/admin/update-service-type",
            methods: ["POST"],
            name: "admin_update_service_type",
        ),
    ]
    ...
    #[
        Route(
            "/api/admin/delete-service-type",
            methods: ["POST"],
            name: "admin_delete_service_type",
        ),
    ]
    public function delete(
        ...
        $connection->executeStatement("DELETE FROM service_type WHERE id = ?", [
            $id,
        ]);
        $this->logger->log(
            "RECORD_DELETED",
