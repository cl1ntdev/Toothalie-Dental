...
export default function Hero() {
  return (
    <section 
className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden pt-20 font-poppins bg-cover bg-center bg-no-repeat"    style={{ backgroundImage: `url(${herobg})` }}
    >
      {/* Background Text */}
      <div className="absolute top-[15%] w-full text-center z-0 flex flex-col items-center px-4">
        <motion.h1
          ...
          className="text-[10vw] leading-none font-light tracking-tight text-slate-800 uppercase font-ceramon"
        >
          Experience <span className="text-blue-600 font-medium">Dental Care</span>
        </motion.h1>
        <motion.h1
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          ...
          className="text-[7.5vw] leading-none font-bold tracking-tight text-slate-900 uppercase mt-[-1%] font-ceramon"
        >
...
>
  <p className="text-5xl text-gray-800 font-medium mb-1"> Are you interested </p>
...
>
  <p className="text-5xl text-gray-800 font-medium mb-1"> We're open to new </p>
...
>
  <p className="text-xs text-gray-500">Platform</p>
      ...
      >
        ...
        <button className="px-8 py-4 bg-gray-900 hover:bg-gray-800 text-white rounded-full font-medium text-sm tracking-wide transition-all shadow-xl hover:-translate-y-1">
          Book an Appointment
        </button>
      </motion.div>
    </section>
