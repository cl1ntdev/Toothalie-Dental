  ...
  useEffect(() => {
    if (scrollRef.current) {
      ...
      if (cardElements[activeIndex]) {
        ...
        const scrollPosition = activeCard.offsetLeft - container.clientWidth / 2 + activeCard.clientWidth / 2;
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-12 gap-8 mb-20">
          <div className="lg:col-span-8">
            <h2 className="text-6xl md:text-[80px] font-light text-gray-900 leading-[0.9] tracking-tight font-ceramon">
        ...
        <div className="relative">
            ...
            {services.map((service, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className={`absolute top-0 inset-x-0 h-[40%] bg-gradient-to-b from-white/95 via-white/70 to-transparent backdrop-blur-[2px] pointer-events-none transition-opacity duration-500 ${isActive ? 'opacity-100' : 'opacity-80 group-hover:opacity-100'}`}></div>
                  ...
                  <div className="relative z-10 p-8 flex flex-col justify-between h-full pointer-events-none">
                    <div>
                      <h3 className={`text-2xl whitespace-pre-line leading-tight mb-3 font-ceramon transition-all duration-500 ${
                        isActive 
                    ...
                    <div className="flex justify-end overflow-hidden">
                      <span className={`text-[80px] leading-none tracking-tighter transition-all duration-500 ${
                        isActive 
          ...
          <div className="absolute bottom-0 left-4 flex gap-3 mt-8">
            <button
              onClick={handlePrev}
              disabled={activeIndex === 0}
              className={`w-12 h-12 rounded-full border flex items-center justify-center transition-all ${
                activeIndex === 0 
                  ? "border-gray-300 text-gray-300 cursor-not-allowed bg-transparent" 
                  : "border-blue-300 text-blue-600 hover:bg-white hover:shadow-md hover:scale-105 bg-white/50 backdrop-blur-sm"
              }`}
            >
