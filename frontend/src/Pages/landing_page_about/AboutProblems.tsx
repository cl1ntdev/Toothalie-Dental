...
export default function AboutProblems() {
  const problems = [
    { id: 1, title: 'Long wait times', desc: 'Spending hours in the waiting room despite having a scheduled appointment.', offset: '-translate-x-12 md:-translate-x-24' },
    { id: 2, title: 'Confusing records', desc: 'Losing track of past treatments, x-rays, and upcoming procedures.', offset: 'translate-x-12 md:translate-x-32' },
    { id: 3, title: 'Booking hassles', desc: 'Playing phone tag just to find an available slot that fits your schedule.', offset: '-translate-x-8 md:-translate-x-16' },
    { id: 4, title: 'Hidden costs', desc: 'Unclear pricing and surprise bills after the treatment is already done.', offset: 'translate-x-8 md:translate-x-20' },
  ];

  return (
    <section className="bg-[#f8f9fa] py-32 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-start mb-32">
          <h2 className="text-5xl md:text-6xl font-light text-[#1a2b2b] leading-tight tracking-tight">
          ...
          {problems.map((prob, index) => (
            ...
            >
              <div className="flex items-start justify-center">
                ...
                <h3 className="text-5xl md:text-7xl font-medium tracking-tight text-[#1a2b2b]">{prob.title}</h3>
              </div>
